...
# _C.DATA.DATA_PATH = ''
_C.DATA.MODEL_SAVE_PATH = ''
# # Dataset name
# _C.DATA.DATASET = 'imagenet'
# # Input image size
_C.DATA.IMG_SIZE = 256 #[512,384] #[2040,1024]#224
...
_C.MODEL.PRINT_FREQ=10
_C.MODEL.TRAIN_EPOCHS=100
_C.MODEL.START_EPOCH=0
_C.MODEL.SAVE_INTERVAL=10
...
_C.MODEL.NUM_CLASSES = 128 #1000
_C.MODEL.OUTPUT_DIM = 128
# Dropout rate
...
_C.TRAIN.EPOCHS = 15 #300
_C.TRAIN.SAVE_INTERVAL = 10
_C.TRAIN.WARMUP_EPOCHS = 2 #20
...
def update_config(config, args):
    ...
    # # set local rank for distributed training      ENABLE THIS FOR DISTRIBUTED TRAINING
